...
public record EnrollmentListItemResponse(
    ...
    @Schema(description = "신청 상태", example = "PENDING") EnrollmentStatus status,
    @Schema(
            description = "결제 확정 시각 (CONFIRMED일 때만)",
            example = "2026-05-01T12:00:00",
            nullable = true)
        LocalDateTime confirmedAt,
    @Schema(description = "강의 요약 (강의 목록 항목과 동일 구조)") ClassListItemResponse lecture) {}
